...
import Contactbg from '../assets/img/Contact/contact-page-background.png';
...
const Contact = () => {
  useEffect(() => {
    ...
    return ( 
        ...
        <section className="info-sec1 contact-bg"  style={{background:`url(${Contactbg}) no-repeat no-repeat center center / cover`}}>
        <Container>
            <Row className='info-sec1-row contact-bg-btn'>
                <Col xs={12} md={12}  className=''>
                <HeadingThree className="contact-inner-title">Join Us </HeadingThree>
          ...
          {/* <Row className='align-items-center info-sec1-row'>
                <Col xs={12} md={12}  className='col1'>
