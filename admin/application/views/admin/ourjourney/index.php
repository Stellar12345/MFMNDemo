            ...
            <div class="card-body">
                <div class="d-inline-block">
                  <h3 class="card-title">
                    ...
                    <?= trans('our journey_list') ?>
                  </h3>
              </div>
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/ourjourney/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add our journey') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/ourjourney/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/ourjourney/list_data')?>');
});
}
//------------------------------------------------------------------
...
$.post('<?=base_url("admin/ourjourney/change_status")?>',
{
