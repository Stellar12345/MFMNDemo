            ...
            <div class="card-body">
                <div class="d-inline-block">
                  <h3 class="card-title">
                    ...
                    <?= trans('Press Releases List') ?>
                  </h3>
              </div>
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/recentnews/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add Press Releases') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/recentnews/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/recentnews/list_data')?>');
});
}
//------------------------------------------------------------------
...
$.post('<?=base_url("admin/recentnews/change_status")?>',
{
