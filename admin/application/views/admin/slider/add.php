              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <!-- For Messages -->
                    ...
                    <?php echo form_open_multipart(base_url('admin/slider/add'), 'class="form-horizontal" onsubmit="return checkMediaSize()"');  ?> 
					<div class="row">
					<div class="col-md-6">
                    <div class="form-group">
                        <label for="slider_title" class="col-md-12 control-label"><?= trans('title *') ?></label>
                        <div class="col-md-12">
                            <input type="text" name="slider_title" class="form-control" id="slider_title" required="true" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="slider_description" class="col-md-12 control-label"><?= trans('description *') ?></label>
                        <div class="col-md-12">
                            <textarea id="summernote" name="slider_description" required="true" style="width: 100%;height: 200px;"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="slider_button_text" class="col-md-12 control-label"><?= trans('button title *') ?></label>
                        <div class="col-md-12">
                            <input type="text" name="slider_button_text" class="form-control" id="slider_button_text" required="true" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="slider_buttin_link" class="col-md-12 control-label"><?= trans('button link *') ?></label>
                        <div class="col-md-12">
                            <input type="text" name="slider_buttin_link" class="form-control" id="slider_buttin_link" required="true" placeholder="">
                        </div>
                    </div>
					 </div>
                    <div  class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="submit" name="submit" value="<?= trans('add_slider') ?>" class="btn btn-primary pull-right">
                        </div>
                    </div>
