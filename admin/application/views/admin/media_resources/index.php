            ...
            <div class="card-body">
                <div class="d-inline-block">
                  <h3 class="card-title">
                    ...
                    <?= trans('Photo Albums List') ?>
                  </h3>
              </div>
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/mediaresources/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('Add Photo Albums') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/mediaresources/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/mediaresources/list_data')?>');
});
}
//------------------------------------------------------------------
