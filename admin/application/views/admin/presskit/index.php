            ...
            <div class="card-body">
                <div class="d-inline-block">
                  <h3 class="card-title">
                    ...
                    <?= trans('press_Kit_list') ?>
                  </h3>
              </div>
			  <div class="d-inline-block float-right">
				<?php /*<a href="<?= base_url('admin/mediaresources/addpresskit'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add NANBAN PressKit') ?></a> */?>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/mediaresources/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/mediaresources/list_presskit_data')?>');
});
}
//------------------------------------------------------------------
...
$.post('<?=base_url("admin/mediaresources/change_status")?>',
{
