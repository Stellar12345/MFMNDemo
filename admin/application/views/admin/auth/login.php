<div class="form-background">
  <div class="login-box">
    <div class="login-logo">
      <h2><a href="<?= base_url('admin'); ?>"><img src="../../assets/dist/img/nanbanblue.png" alt="<?= $this->general_settings['application_name']; ?>" /></a></h2>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg"><?= trans('Nanban Admin Login') ?></p>
        ...
        <?php echo form_open(base_url('admin/auth/login'), 'class="login-form" '); ?>
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <input type="submit" name="submit" id="submit" class="btn btn-primary btn-block btn-flat" value="<?= trans('sign-in') ?>">
            </div>
            <!-- /.col -->
          </div>
        <?php echo form_close(); ?>
