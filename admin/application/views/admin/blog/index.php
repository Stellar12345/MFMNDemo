        ...
        <div class="card">
            <div class="card-body">
			  ...
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/blog/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add blog') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/blog/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/blog/list_data')?>');
});
}
//------------------------------------------------------------------
...
$.post('<?=base_url("admin/blog/change_status")?>',
{
