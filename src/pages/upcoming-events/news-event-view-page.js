...
import MyBackgroundImage from "../../assets/img/newsnevents/newsnevents-view-page-bg.jpg";
          ...
          <Row>
            <Col md={12}>
              <HeadingOne className="restoration-text">
                <Link to="javascript:void(0)">News & Events</Link> / <span id="nanban-volleyball">{news.post_title}</span>
              </HeadingOne>
            </Col>
          </Row>
        </Container>
      ...
      <MyDiv className="single-post">
        <Container>
          <Row>
            ...
            <PTag className="pro-cat-list">{parse(news.post_description && news.post_description)}</PTag>
...
export default Newsneventsview;
