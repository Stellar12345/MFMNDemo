      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          <div class="d-inline-block">
              ...
              <?= trans('Add Photo Albums') ?> </h3>
          </div>
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/mediaresources'); ?>" class="btn btn-success"> <i class="fa fa-list"></i> Photo Albums List</a>
          </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
                ...
                <div class="box-body">
                  ...
                  <!-- For Messages -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" name="media_title" class="form-control required" required="true" id="media_title" placeholder="Media Title">
                        </div>
                    </div>
                    <div  class="col-md-12">
                        <label  class="control-label"><?= trans('Upload file') ?></label><br/>
                        <input type="file" id="media_image" name="media_image" accept=".png, .jpg, .jpeg, .gif, .svg" >
			  ...
			  <select name="status" class="form-control">                 
				  ...
				  <option value="0"><?= trans('inactive') ?></option>  
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="submit" name="submit" value="<?= trans('add Photo Albums') ?>" class="btn btn-primary pull-right">
                        </div>
                    </div>
                  <?php echo form_close(); ?>
                </div>
