        ...
        <div class="card">
            <div class="card-body">
			  ...
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/slider/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add slider') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/slider/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/slider/list_data')?>');
});
}
//------------------------------------------------------------------
...
$.post('<?=base_url("admin/slider/change_status")?>',
{
