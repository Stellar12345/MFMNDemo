        ...
        <div class="card">
            <div class="card-body">
			  ...
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/gallery/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add gallery') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/gallery/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/gallery/list_data')?>');
});
}
//------------------------------------------------------------------
