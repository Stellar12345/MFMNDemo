            ...
            <div class="card-body">
                <div class="d-inline-block">
                  <h3 class="card-title">
                    ...
                    <?= trans('our people_list') ?>
                  </h3>
              </div>
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/ourpeople/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add our people') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/ourpeople/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/ourpeople/list_data')?>');
});
}
//------------------------------------------------------------------
...
$.post('<?=base_url("admin/ourpeople/change_status")?>',
{
