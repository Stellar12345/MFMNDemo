            ...
            <div class="card-body">
                <div class="d-inline-block">
                  <h3 class="card-title">
                    ...
                    <?= trans('blog_category List') ?>
                  </h3>
              </div>
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/blog/add_category'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add blog category') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/blog/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/blog/category_data')?>');
});
}
//------------------------------------------------------------------
...
$.post('<?=base_url("admin/blog/change_status_category")?>',
{
