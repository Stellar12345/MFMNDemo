            ...
            <div class="card-body">
                <div class="d-inline-block">
                  <h3 class="card-title">
                    ...
                    <?= trans('media_coverage_list') ?>
                  </h3>
              </div>
			  <div class="d-inline-block float-right">
				<a href="<?= base_url('admin/media/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add media coverage') ?></a>
			  </div>
            </div>
            <div class="card-body">
...
$.post('<?=base_url('admin/media/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/media/list_data')?>');
});
}
//------------------------------------------------------------------
...
$.post('<?=base_url("admin/media/change_status")?>',
{
