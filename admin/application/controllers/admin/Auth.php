...
class Auth extends MY_Controller {
	...
	public function login(){
		...
		public function get_country_states()
		{
		    ...
		    $html = form_dropdown('state',$options,(!empty($_POST['state_id'])?$_POST['state_id']:''),'class="select2 state" style="width: 100%;" required');
		...
		public function get_state_cities()
		{
		    ...
		    $html = form_dropdown('city',$options,(!empty($_POST['city_id'])?$_POST['city_id']:''),'class="select2 city" style="width: 100%;" required');
			$error =  array('msg' => $html);
			echo json_encode($error);
		}
