...
class Auth_model extends CI_Model{
	...
	public function change_pwd($data, $id){
		...
		public function get_all_posts(){			return $this->db->count_all('ci_news');		}		public function get_active_posts(){			$this->db->where('is_active', 1);			return $this->db->count_all_results('ci_news');		}		public function get_deactive_posts(){			$this->db->where('is_active', 0);			return $this->db->count_all_results('ci_news');		}
}
