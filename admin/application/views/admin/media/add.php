            ...
            <div class="col-md-6">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <!-- For Messages -->
                    ...
                    <?php echo form_open_multipart(base_url('admin/media/add'), 'class="form-horizontal" onsubmit="return checkMediaSize()"');  ?> 
                    <div class="form-group">
                        <label for="post_title" class="col-md-12 control-label"><?= trans('title *') ?></label>
                        <div class="col-md-12">
                            <input type="text" name="post_title" class="form-control" id="post_title" required="true" placeholder="Media Title">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="post_title" class="col-md-12 control-label"><?= trans('Date *') ?></label>
                        <div class="col-md-12">
                            <input type="date" name="post_date" class="form-control" required="true" placeholder="Media Date">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="url" name="post_link" class="form-control" id="post_link" placeholder="https://www.youtube.com/nanbanfdn">
							<br>
						or
                        </div>
			  ...
			  <select name="status" class="form-control">                 
				  ...
				  <option value="0"><?= trans('inactive') ?></option>  
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="submit" name="submit" value="<?= trans('Add Media Coverage') ?>" class="btn btn-primary pull-right">
                        </div>
                    </div>
                  <?php echo form_close(); ?>
                </div>
