            ...
            <div class="col-md-6">
                ...
                <div class="box-body">
                  ...
                  <!-- For Messages -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea id="summernote" name="post_description" style="width: 100%;height: 200px;"></textarea>
                        </div>
                    </div>
                    <div  class="col-md-12">
			  ...
			  <select name="status" class="form-control">                 
				  ...
				  <option value="0"><?= trans('inactive') ?></option>  
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="submit" name="submit" value="<?= trans('add_news') ?>" class="btn btn-primary pull-right">
                        </div>
                    </div>
                  <?php echo form_close(); ?>
                </div>
